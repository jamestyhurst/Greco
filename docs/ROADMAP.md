...
| 16 | **Expand knowledge corpus beyond Capablanca** — deposit at least two more public-domain books per `knowledge/README.md` and the SHOPPING_LIST. Good first targets: Nimzowitsch's *My System*, Tarrasch's *The Game of Chess*, or a Euwe game collection. (Acquisition is a **Claude Cowork** task — book hunting/cleaning — not a Claude Code one.) | M | **in-progress** — 6 more books acquired 2026-06-18; corpus at 16 texts / 1456 chunks |
